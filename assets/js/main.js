...
const cardbody1 = document.getElementById("card1")
cardbody1.addEventListener("mouseenter", () => {
  text1.style.display = " block "
})

cardbody1.addEventListener("mouseleave", () => {
...
function validate() {
  ...
  if (name_box.value == null || name_box.value == "") {
    alert('Please fill your name field');
    
    
    return false;
  } else if( email_box.value == null || email_box.value == "") {
    
    alert('Please fill your email field');


  } else if( subject_box.value == null || subject_box.value == "") {
    
    alert('Please fill your subject field');
    

  } else if( message_field.value == null || message_field.value == "") {
    
    alert('Please fill your message field');
